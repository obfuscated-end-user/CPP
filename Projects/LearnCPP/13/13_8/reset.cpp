...
public:
    ...
    void reset() {
        ...
        *this = Foo(); // create new Foo object, then use assignment to overwrite our implicit object
        // *this references this object. making it equal to Foo() means override the current object's values witht the defaults above. what the fuck did you just write here, dumbass?
    }
};
