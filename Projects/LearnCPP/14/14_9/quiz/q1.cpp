...
// the fuck you wrote this shit as a class before fucking retard
// god fucking damn it read the instructions thoroughly next time
// so you won't look like a idiot staring at his fucking screen
struct StudentGrade {   // struct, not a fucking class
    std::string name;
    char grade;
};
