...
int main(int argc, char* argv[]) {
    ...
    // argv[count] is a fucking char* array remember that retard
...
/*
since i wrote all of this shit in vs code, where there is this complex ass bullshit every time i run the program:
"PS E:\Projects\CPP> cd "e:\Projects\CPP\Projects\LearnCPP\12\12_5\" ; if ($?) { g++ main_argc_argv.cpp -o main_argc_argv } ; if ($?) { .\main_argc_argv }"

i can't pass in the arguments directly because either i'm fucking retarded or that it is not allowed to be done in vs code
whatever what the fuck just learn this shit it will eventually go away fuck all of you
*/