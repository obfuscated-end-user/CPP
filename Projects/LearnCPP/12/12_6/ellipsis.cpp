...
int main() {
    ...
    std::cout << findAverage(6, 1.0, 2, 3, 4, 5, 6) << '\n';    // what the fuck, va_arg() was told that the list only contains ints, but fucktards like you pass in a double just because
    int value = 7;
    ...
    // regarding the count parameter, that means that if you change the first integer argument, you risk fucking up the function call
    return 0;
}