...
int main() {
	...
	// which we can do via the data() member function of std::aray or std::vector
...
// doesn't work lol
// cd "DIRECTORY\CONTAINING\THIS\FILE" ; if ($?) { g++ -std=c++23 "std_mdspan.cpp" -o "std_mdspan" } ; if ($?) { & ".\std_mdspan" }