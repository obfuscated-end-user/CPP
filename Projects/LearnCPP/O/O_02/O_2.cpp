...
int main() {
    ...
    // "<< and >> are used for inputs and outputs, what's with this binary crap?"
    ...
    // true | false evaluates to true, so the answer is 1 on the first position. (explain this better)
    // 1st: 0101
    // 2nd: 0110
    // ans: 0111
