...
public:
    ...
    int& operator[](int index) {
        // prevents stupid shit like IntArray[-1239923]
    ...
    void reallocate(int newLength) {
        ...
        // else allocate new shit
        m_data = new int[newLength];
        m_length = newLength;
    }

    // this also resizes the array, but is slow as shit
    void resize(int newLength) {
        ...
        if (m_length > 0) {
            // determine which array has more shit
        ...
        // usual shit when comes to pointer magic
        delete[] m_data;
